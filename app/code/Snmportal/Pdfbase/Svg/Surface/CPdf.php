...
namespace Snmportal\Pdfbase\Svg\Surface;
...
//      }
    ...
    private function openFont($font)
    {
        ...
        if (file_exists($fontcache . $cache_name)) {
            ...
            $this->fonts[$font] = file_get_contents($fontcache . $cache_name);//AUIT32require($fontcache . $cache_name);
            $this->fonts[$font] = ObjectManager::getInstance()->get('\Magento\Framework\Serialize\Serializer\Json')->unserialize($this->fonts[$font]);
