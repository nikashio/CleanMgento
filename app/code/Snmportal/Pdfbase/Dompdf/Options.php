...
class Options
{
     ...
     * @see Snmportal\Pdfbase\Dompdf\Adapter\CPDF::PAPER_SIZES for valid sizes
     *
     * @var string
     */
     ...
     * CPDF. 'GD' renders PDFs to graphic files. {@link Snmportal\Pdfbase\Dompdf\CanvasFactory}
