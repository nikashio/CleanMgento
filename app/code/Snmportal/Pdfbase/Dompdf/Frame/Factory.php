 ...
 */
namespace Snmportal\Pdfbase\Dompdf\Frame;
...
use DOMXPath;
use Snmportal\Pdfbase\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use Snmportal\Pdfbase\Dompdf\FrameReflower\Page as PageFrameReflower;
...
class Factory
{
    ...
    static function decorate_frame(Frame $frame, Dompdf $dompdf, Frame $root = null)
    {
        ...
        $positioner = "\\Snmportal\\Pdfbase\\Dompdf\\Positioner\\$positioner";
        $decorator = "\\Snmportal\\Pdfbase\\Dompdf\\FrameDecorator\\$decorator";
        $reflower = "\\Snmportal\\Pdfbase\\Dompdf\\FrameReflower\\$reflower";
