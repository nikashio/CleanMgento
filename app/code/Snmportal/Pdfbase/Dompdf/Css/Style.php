 ...
 */
namespace Snmportal\Pdfbase\Dompdf\Css;
...
class Style
{
    ...
    function get_font_family()
    {
        ...
        if ($DEBUGCSS) {
//AUIT            print "<pre>[get_font_family:";
//AUIT            print '(' . $this->_props["font_family"] . '.' . $font_style . '.' . $this->__get("font_weight") . '.' . $weight . '.' . $subtype . ')';
        }
...
//AUIT                print '(' . $family . ')';
            ...
            if ($font) {
//AUIT                if ($DEBUGCSS) print '(' . $font . ")get_font_family]\n</pre>";
...
//AUIT            if ($DEBUGCSS) print '(' . $font . ")get_font_family]\n</pre>";
    ...
    */
    ...
    protected function _image($val)
    {
        ...
        if ($DEBUGCSS) {
//AUIT            print "<pre>[_image\n";
//AUIT            print_r($parsed_url);
//AUIT            print $this->_stylesheet->get_protocol() . "\n" . $this->_stylesheet->get_base_path() . "\n" . $path . "\n";
//AUIT            print "_image]</pre>";;
        }
        return $path;
    }
                    ...
                    switch ($name) {
                        ...
                        case "skewY":
                            foreach ($values as $i => $value) {
                                if (strpos($value, "rad")!== false) { //AUIT
