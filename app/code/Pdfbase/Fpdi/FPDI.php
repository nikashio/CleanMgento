...
use LogicException;
use Snmportal\Pdfbase\Fpdi\FpdiPdfParser;
use Snmportal\Pdfbase\Fpdi\pdfparser;

//if (!class_exists('\Snmportal\Pdfbase\Fpdi\FPDF_TPL')) {
...
class FPDI extends FPDFTPL
{
    ...
    {
      //  if (!class_exists('\Snmportal\Pdfbase\Fpdi\fpdiPdfParser')) {
//AUIT7.3            require_once('fpdi_pdfparser.php');
        //}
        return new \Snmportal\Pdfbase\Fpdi\FpdiPdfParser($filename);
    }
        ...
        foreach ($this->parsers as $filename => $p) {
            ...
            while (($n = key($this->_objStack[$filename])) !== null) {
                try {
                    ...
                    $nObj = [pdfparser::TYPE_OBJECT, pdfparser::TYPE_NULL];
                }
    ...
    protected function _writeValue(&$value)
    {
        ...
        switch ($value[0]) {
            ...
            case pdfparser::TYPE_DICTIONARY:
                ...
                //PHP 7.2 while (list($k, $v) = each($value[1])) {
