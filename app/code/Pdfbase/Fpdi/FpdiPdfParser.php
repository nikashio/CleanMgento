...
//if (!class_exists('\Snmportal\Pdfbase\Fpdi\pdf_parser')) {
    //AUIT7.3 require_once('pdf_parser.php');
//}
use Exception;
...
class FpdiPdfParser extends pdfparser
{
    ...
    public function setPageNo($pageNo)
    {
        ...
        if ($pageNo < 0 || $pageNo >= $this->getPageCount()) {
            throw new InvalidArgumentException('Invalid page number! Please use PDF tempalte with two pages!!');
        }
    ...
    protected function _getPageContent($contentRef)
    {
        ...
        } elseif ($contentRef[0] == pdfparser::TYPE_ARRAY) {
