 ...
 */
namespace Snmportal\Pdfbase\Dompdf\Renderer;

use Exception;
use Snmportal\Pdfbase\Dompdf\Adapter\CPDF;
use Snmportal\Pdfbase\Dompdf\Canvas;
use Snmportal\Pdfbase\Dompdf\Css\Color;
use Snmportal\Pdfbase\Dompdf\Css\Style;
...
abstract class AbstractRenderer
{
    ...
    protected function _background_image($url, $x, $y, $width, $height, $style)
    {
        ...
        //debugpng
//AUIT        if ($this->_dompdf->get_option("debugPng")) print '[_background_image ' . $url . ']';
...
//AUIT                print 'Unknown repeat!';
        ...
        if (!$is_png && $this->_canvas instanceof CPDF) {
            ...
            //debugpng
//AUIT            if ($this->_dompdf->get_option("debugPng")) print '[_background_image ' . $tmp_file . ']';
            ...
            //debugpng
//AUIT            if ($this->_dompdf->get_option("debugPng")) print '[_background_image unlink ' . $tmp_file . ']';
