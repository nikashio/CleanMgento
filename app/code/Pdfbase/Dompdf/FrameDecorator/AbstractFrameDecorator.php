...
use Snmportal\Pdfbase\Dompdf\Frame\FrameTreeList;
use Snmportal\Pdfbase\Dompdf\Frame\Factory;
use Snmportal\Pdfbase\Dompdf\FrameReflower\AbstractFrameReflower;
use Snmportal\Pdfbase\Dompdf\Css\Style;
use Snmportal\Pdfbase\Dompdf\Positioner\AbstractPositioner;
...
abstract class AbstractFrameDecorator extends Frame
{
    ...
    function reflow(Block $block = null)
    {
