...
namespace Snmportal\Pdfprint\Model\Pdf\Barcode;

use Snmportal\Pdfbase\Barcode\Datamatrix;
use Snmportal\Pdfbase\Barcode\PDF417;
use Snmportal\Pdfbase\Barcode\QRcode;
...
class Barcode
{
    ...
    public function getBarcode1D($type, $code, $w = 2, $h = 30, $color = 'black')
    {
        ...
        return $this->getAsSVGimg1($w, $h, $color);
    }
    ...
    public function getAsSVGimg1($w = 2, $h = 30, $color = 'black')
    {
        $repstr = ["\0" => '', '&' => '&amp;', '<' => '&lt;', '>' => '&gt;'];
        $svg = '';
        $svg .= '<svg width="' . round(
            ...
            3
        ) . '" height="' . $h . '" version="1.1" xmlns="http://www.w3.org/2000/svg">' . "\n";
    ...
    public function getBarcode2D($type, $code, $w = 3, $h = 3, $color = 'black')
    {
        $mode = explode(',', $type);
...
//                require_once(__DIR__ . '/../../../Service/Pdf/Barcode/Datamatrix.php');
...
//                require_once(__DIR__ . '/../../../Service/Pdf/Barcode/PDF417.php');
            ...
            case 'QRCODE':
            { // QR-CODE
//                require_once(__DIR__ . '/../../../Service/Pdf/Barcode/QRcode.php');
        ...
        return $this->getAsSVGimg($w, $h, $color);
    }

    public function getAsSVGimg($w, $h, $color)
    {
        $repstr = ["\0" => '', '&' => '&amp;', '<' => '&lt;', '>' => '&gt;'];
        $svg = '';
